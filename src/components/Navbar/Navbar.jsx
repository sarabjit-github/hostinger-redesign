...
import indiaLogo from "../../img/India.svg";
import caretIcon from "../../img/caret-down.svg";
import webHosting from "../../img/web-hosting.svg";
import cloudHosting from "../../img/cloud-hosting.svg";
import wordpressHosting from "../../img/wordpress-hosting.svg";
import vpsHosting from "../../img/vps-hosting.svg";
import cyberHosting from "../../img/cyber-panel.svg";
import minecraftHosting from "../../img/minecraft-hosting.svg";
import googleImg from "../../img/google.svg";
import hostingerEmailImg from "../../img/h-email.svg";
import domainImg from "../../img/domain-checker.svg";
...
export const Navbar = () => {
  ...
  return (
    <header
      className="navbar"
      style={{
        background: scrollY > 0 ? "white" : "",
        boxShadow: scrollY > 0 ? "0px 1px 20px 4px rgba(0,0,0, 0.05)" : "none",
        height: scrollY > 0 ? "90px" : "",
      }}
    >
          ...
          <li>
            <a href="#">
              ...
              <ul className="sm-menu">
                ...
                <a href="#">
                  <div className="a-img">
                    <img src={cyberHosting} alt="img" />
                  </div>
                  <div className="a-txt">
                    <span>CyberPanel Hosting</span>
                    <p>Control panel with Open/Lite Speed Webserver.</p>
                  </div>
                </a>
                <a href="#">
                  <div className="a-img">
                    <img src={minecraftHosting} alt="img" />
                  </div>
                  <div className="a-txt">
          ...
          <li>
            <a href="#">
              ...
              <ul className="sm-menu">
                ...
                <a href="#">
                  <div className="a-img">
                    <img src={hostingerEmailImg} alt="img" />
                  </div>
                  <div className="a-txt">
                    <span>Hostinger Email Hosting</span>
          ...
          <li>
            <a href="#">
              ...
              <ul className="sm-menu">
                ...
                <a href="#">
                  <div className="a-img">
                    <img src={domainTransfer} alt="img" />
                  </div>
                  <div className="a-txt">
